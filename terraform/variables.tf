...
variable "router_name" {
  ...
  validation {
    condition     = can(regex("^[a-zA-Z0-9]([-_a-zA-Z0-9]*[a-zA-Z0-9])?(\\.[a-zA-Z0-9]([-_a-zA-Z0-9]*[a-zA-Z0-9])?)*$", var.router_name))
    error_message = "Value of router_name should be upper / lowercase and can only contain alphanumeric characters and hyphens(-) and underscores(_)."
  }
}
